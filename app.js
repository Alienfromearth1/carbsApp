...
var url = "mongodb+srv://Admin:KyLZ2Z3JfPyyhy8E@carbapp-njtra.mongodb.net/CarbDatabase?retryWrites=true";
...
app.get("/", function(req, res){
	...
	res.sendFile("F:/carbsApp/login.html");
...
app.get("/home", function(req, res){
	res.sendFile("F:/carbsApp/home.html");
});

//route to handle the path(/food)
app.get("/food", function(req, res){
	res.sendFile("F:/carbsApp/food.html");
});
...
app.get("/register", function(req, res){
	res.sendFile("F:/carbsApp/register.html");
});
